        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div>
            ...
            <p className="text-sm text-gray-400 leading-relaxed mb-4">
              Independent matching service connecting Essex homeowners with vetted, experienced driveway gate installers across every corner of the county.
            </p>
            <p className="text-xs text-gray-500 italic border-l-2 border-gray-700 pl-3">
              Driveway Gates Essex is a referral service. We connect you with independent gate installers. We do not carry out installations ourselves.
            </p>
          </div>
