// data/pricing.ts
// Essex driveway gate pricing data (2026 market rates)
...
export const pricingTiers: PricingTier[] = [
  {
    ...
    description: 'Complete sliding gate package including gate fabrication, ground track, automation motor, two remote controls, and safety sensors. Ideal for Essex driveways with limited swing clearance.',
  },
  {
    ...
    description: 'Double or single swing gate with underground or ram-arm automation, posts, remote controls, and safety features. The most popular choice for Essex residential driveways.',
  },
  {
...
export const financeInfo = {
  ...
  description: 'Many of our Essex installers offer 0% finance on gate installations, letting you spread the cost from as little as £99 per month. Subject to status and approval.',
};
