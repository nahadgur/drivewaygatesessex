...
export const services: Service[] = [
  {
    ...
    faqs: [
      {
        question: 'How much space do I need for a sliding gate?',
        answer: 'You need clear space along your boundary wall or fence equal to the width of the gate opening, plus about 500mm. So if your driveway entrance is 4 metres wide, you need roughly 4.5 metres of unobstructed wall to one side. Our Essex installers will measure during the site survey and advise on any adjustments needed.',
      },
      {
        question: 'Can a sliding gate work on a sloped driveway?',
        answer: 'Yes, but it takes careful planning. Sliding gates run on a ground track, so the track needs to be level even if the driveway itself slopes. Experienced installers can work with gradients by adjusting the track bed and using cantilever systems for steeper sites. This is something to discuss at the survey stage.',
      },
      {
        question: 'How long does a sliding gate installation take?',
        answer: 'Most residential sliding gate installations in Essex take 2 to 4 days. Day one covers groundwork, track laying, and post installation. Day two is the gate itself and automation. Days three and four, if needed, handle finishing, intercom wiring, and final testing. Complex sites or bespoke designs may take a day or two longer.',
      },
    ],
  },
  {
    ...
    description: 'Classic double or single swing gates with electric automation. The most popular choice for Essex driveways with enough clearance in front of or behind the gate.',
    image: '/images/gates/gate-aluminium-swing-open-luxury-garden.png',
    icon: 'Shield',
    color: 'emerald',
    faqs: [
      {
        question: 'Should my swing gates open inward or outward?',
        answer: 'In most cases, gates must open inward onto your property. UK planning rules generally prevent gates from opening outward over a public footpath or road. If your driveway slopes downward from the road, inward opening can be tricky, so your installer may recommend underground motors or articulated arm systems to manage the gradient.',
      },
      {
        question: 'How wide should swing gates be?',
        answer: 'For a comfortable fit, most Essex driveways work well with a total opening of 3 to 4 metres for cars, or up to 5 metres if you need space for larger vehicles. Your installer will assess the driveway width, pillar positions, and turning angles during the survey. Double gates split the opening into two leaves for a balanced look.',
      },
      {
        question: 'Do swing gates need planning permission?',
        answer: 'Generally no, provided the gate is under 2 metres tall (or under 1 metre if next to a highway) and your property is not listed or in a conservation area. Some Essex districts have additional guidelines, so your installer will advise on any local restrictions during the initial consultation.',
      },
    ],
  },
  {
    ...
    faqs: [
      {
        question: 'How long do wooden driveway gates last?',
        answer: 'With proper treatment and maintenance, hardwood gates like iroko or oak can last 25 years or more. Treated softwood gates typically last 10 to 15 years. Essex\'s varied climate means regular re-staining or oiling is important. Most of our installers offer maintenance packages that include annual treatments to keep your gates looking and performing their best.',
      },
      {
        question: 'Can wooden gates be automated?',
        answer: 'Absolutely. Wooden gates work perfectly with both underground swing motors and ram-arm automation systems. The key consideration is the weight of the gate. Hardwood gates are heavier, so the motor needs to be rated for the load. Your installer will specify the right motor for the timber type and gate size during planning.',
      },
      {
        question: 'What type of wood is best for Essex weather?',
        answer: 'Iroko is the top choice because it is naturally resistant to moisture and does not warp easily. European oak is another excellent option with a more traditional look. Western red cedar is lighter and works well for smaller gates. Accoya, a modified wood with a 50-year guarantee, is increasingly popular for Essex properties that want maximum longevity with minimal upkeep.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    description: 'Keep your gates running smoothly with regular servicing, or fix problems fast with same-day repair callouts across Essex. Motors, hinges, intercoms, and safety systems.',
