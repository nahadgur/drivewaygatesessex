...
export const services: Service[] = [
  {
    ...
    faqs: [
      ...
      {
        question: 'Can a sliding gate be installed on a sloped driveway in Essex?',
        answer: 'Yes, though it requires more planning than a flat site. The track itself must be level regardless of the gradient, which means the installer needs to build up the track bed on a slope or opt for a cantilever system that clears the ground entirely. Both solutions are well-established and widely used across Essex, particularly on the hilly ground around Epping and Loughton. Bring photographs of your driveway to the site survey so the installer can assess the gradient before visiting.',
      },
      {
        question: 'How long does a sliding gate installation take in Essex?',
  ...
  },
  {
    ...
    description: 'The most widely installed gate type across Essex. A single or double leaf gate powered by underground or ram-arm motors, combining a traditional appearance with modern automated convenience.',
    ...
    faqs: [
      ...
      },
      {
        ...
        answer: 'The gate opening should match your actual traffic requirement, not just the width of the gap. A single car requires a minimum clear opening of 2.7 metres; two cars passing comfortably need at least 5 metres. Most residential driveways in Essex fall between 3 and 4 metres, which works well with a standard double gate split into two equal leaves. If the opening is wider than 5 metres, your installer will likely recommend sliding as a more structurally sound option, as very wide swing leaves put significant stress on the post foundations and motors.',
      },
      {
        question: 'Do electric swing gates require planning permission in Essex?',
        answer: 'In the majority of cases, no. Permitted development rights cover gates up to 2 metres in height that open inward and are not adjacent to a classified road. The limit drops to 1 metre for gates that front a highway. Listed buildings and conservation area properties require consent regardless of height, and several Essex districts, including Epping Forest and parts of Colchester, have additional local conditions that apply in designated areas. Your installer will confirm the position at the site survey stage.',
      },
    ],
  },
  {
    ...
    description: 'Bespoke hardwood gates crafted to specification in iroko, European oak, or Accoya. The natural choice for period properties, barn conversions, and rural Essex homes where character matters as much as security.',
    image: '/images/gates/gate-wooden-oak-swing-cottage-garden.png',
    icon: 'Sparkles',
    color: 'amber',
    faqs: [
      {
        question: 'How long do hardwood driveway gates last in Essex?',
        answer: 'A properly specified and maintained hardwood gate will outlast almost any other material. Iroko, the most widely used species for Essex residential gates, has a natural oil content that resists moisture absorption and resists warping through damp winters and dry summers. With an oil treatment every two years, an iroko gate will remain structurally sound and presentable for 25 to 30 years. European oak performs similarly and weathers to an attractive silver-grey if left untreated. Accoya, a modified radiata pine with a 50-year above-ground durability guarantee, is the low-maintenance premium option.',
      },
      {
      ...
      {
        question: 'Which timber species works best for Essex weather conditions?',
        answer: 'Iroko is the most reliable all-round choice for Essex. It is naturally durable to Use Class 3 without treatment, resists surface checking in hot dry summers, and holds its shape through the damp winters typical of East Anglia. European oak is equally durable and preferred where the grain and character of the timber are a design priority. Western red cedar is a lighter option suited to smaller gates or slatted contemporary designs. Accoya is the right choice for homeowners who want a documented 50-year lifespan with minimal annual maintenance, particularly on coastal Essex properties where the salt-laden air accelerates weathering.',
      },
    ],
  },
  {
    ...
    description: 'Fabricated steel, aluminium, and wrought iron gates built to last. From hand-forged ornate ironwork on Essex estate properties to precision-cut contemporary aluminium on modern builds.',
  ...
  },
  {
    ...
    description: 'Diagnostic callouts, motor replacement, hinge realignment, safety sensor calibration, and annual service contracts across Essex. Most faults resolved on the first visit.',
