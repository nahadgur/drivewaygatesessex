...
const serviceContent: Record<string, { intro: string[]; benefits: { title: string; desc: string }[]; candidateIntro: string; candidates: string[]; process: { title: string; desc: string }[] }> = {
  'electric-sliding': {
    ...
    benefits: [
      ...
      { title: 'Handles Large Openings', desc: 'Sliding gates can cover much wider openings than swing gates. Openings of 5 to 8 metres are straightforward, making them ideal for double-width driveways and rural Essex properties with wider entrances.' },
  ...
  'electric-swing': {
    intro: [
      "Electric swing gates are the most popular choice for Essex residential driveways. They consist of a single or double gate leaf that swings open, typically inward onto the property, powered by underground or ram-arm motors. The classic look of a pair of swing gates opening as you approach is hard to beat, and they suit everything from Victorian cottages to modern detached homes across the county.",
      ...
      "The main consideration with swing gates is clearance. You need enough space for the gate to swing fully open without hitting parked cars, walls, or the driveway surface. If your driveway slopes, the gate needs to clear the gradient as it swings. Experienced Essex installers deal with these challenges daily and will recommend the right motor type and hinge configuration during the survey.",
    ],
    benefits: [
      ...
      { title: 'Hidden Motor Options', desc: 'Underground motors sit beneath the post cap and are completely invisible when the gate is closed. This gives a clean, uncluttered look that many Essex homeowners prefer.' },
  ...
  'wooden-gates': {
    intro: [
      "Wooden driveway gates bring a warmth and natural character to Essex properties that metal simply cannot replicate. Whether you are after a rustic tongue-and-groove design for a period cottage in Saffron Walden or a sleek contemporary horizontal-slat gate for a modern Brentwood build, timber offers a huge range of design possibilities. The most popular hardwoods for Essex gates are iroko, European oak, and western red cedar.",
      ...
      "The question most Essex homeowners ask about wooden gates is longevity. With the right timber and proper treatment, hardwood gates last 25 years or more. Iroko is naturally oily and resists moisture without heavy treatment. Oak weathers to a beautiful silver-grey if left untreated, or can be oiled to retain its golden colour. Accoya, a modified softwood with a 50-year manufacturer guarantee, is becoming increasingly popular for Essex homeowners who want maximum lifespan with minimal maintenance.",
    ],
    benefits: [
      { title: 'Natural Beauty', desc: 'No other material matches the warmth, texture, and character of real wood. Timber gates age gracefully and develop a patina that improves with time, especially in Essex garden settings.' },
      ...
      { title: 'Privacy and Sound Reduction', desc: 'Solid timber gates provide excellent visual screening and reduce road noise more effectively than metal or slatted designs. Ideal for Essex properties on busier roads.' },
      { title: 'Sustainable Material Choice', desc: 'Responsibly sourced hardwood is a renewable material with a far lower carbon footprint than steel or aluminium. FSC-certified timber is available from all our Essex installers.' },
    ],
  ...
  'metal-gates': {
    intro: [
      "Metal driveway gates offer Essex homeowners the widest range of styles, from ornate wrought iron scrollwork to ultra-modern flat-bar designs with horizontal slats. The three main metals used are mild steel, aluminium, and wrought iron, each with different strengths. Steel is the most popular for bespoke gates because it balances strength, design flexibility, and cost. Aluminium is lightweight and completely rust-proof. Wrought iron is hand-forged and suits traditional properties.",
      "Every reputable Essex installer hot-dip galvanises steel and iron gates before applying a powder coat finish. This two-stage protection process means the gate is virtually immune to rust for 20 years or more. For coastal Essex properties near Southend, Frinton, or Mersea Island, this protection is especially important given the salt-laden air. Aluminium does not rust at all and only needs a powder coat for colour.",
      "Design-wise, metal gates can be as simple or as elaborate as you want. Flat-bar contemporary designs with clean lines and geometric patterns are hugely popular right now. Traditional estate-style gates with curved tops, finials, and scrollwork remain a strong choice for period properties. Most Essex fabricators will produce CAD drawings or 3D renders of your design so you can see exactly how the gate will look on your property before committing.",
    ],
    benefits: [
      { title: 'Maximum Durability', desc: 'Galvanised and powder-coated metal gates last 25 years or more with virtually no maintenance. They handle Essex weather, coastal salt, and daily use without degrading.' },
  ...
  'automated-systems': {
    ...
    benefits: [
      { title: 'Never Leave Your Car', desc: 'Open and close your gates from the comfort of your vehicle with a remote or phone app. On rainy Essex mornings, this alone makes the investment worthwhile.' },
  ...
  'gate-repair': {
    ...
    benefits: [
      { title: 'Fast Response Times', desc: 'Most Essex gate engineers in our network can attend within 24 to 48 hours for urgent repairs. Some offer same-day emergency callouts for gates stuck open or in a dangerous position.' },
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mt-6">
              <div>
                ...
                <div className="space-y-3">
                  {['Compare up to 3 free quotes', 'Every installer vetted and insured', `${totalCities}+ Essex locations covered`].map((item, i) => (
            ...
            <div className="lg:col-span-2">
              ...
              <section className="mb-14">
                <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-6">
                  <div>
                    <h2 className="text-2xl md:text-3xl font-display font-bold text-gray-900 mb-2">Find {service.title} Installers Across Essex</h2>
                    <p className="text-gray-600">
                      We have vetted installers for {service.title.toLowerCase()} in over {totalCities} areas across Essex.
                    </p>
                  </div>
                  <button
            ...
            <aside className="lg:col-span-1">
              <div className="sticky top-28 space-y-6">
                <div className="bg-white p-6 rounded-2xl shadow-lg border border-gray-100">
                  ...
                  <p className="text-gray-600 mb-5 text-sm">Free, no-obligation match with vetted installers in your Essex area.</p>
