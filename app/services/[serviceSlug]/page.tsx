...
const serviceContent: Record<string, { intro: string[]; benefits: { title: string; desc: string }[]; candidateIntro: string; candidates: string[]; process: { title: string; desc: string }[] }> = {
  'electric-sliding': {
    ...
    benefits: [
      ...
      { title: 'Performs Well on Slopes', desc: 'While the ground track must be level, the driveway itself can slope. Experienced Essex installers build a level track bed into a sloped site as a matter of routine, or specify a cantilever system where the ground cannot accommodate a track at all.' },
    ...
    candidateIntro: "A sliding gate is likely the right choice for your Essex property if:",
    candidates: [
  ...
  'electric-swing': {
    ...
    benefits: [
      ...
      { title: 'Lower Installed Cost Than Sliding', desc: 'Swing gate installations typically cost £500 to £2,000 less than an equivalent sliding system because there is no track foundation, less groundwork, and simpler motor mounting. For most standard Essex driveways the savings are genuine.' },
  ...
  'wooden-gates': {
    ...
    benefits: [
      ...
      { title: 'Effective Privacy and Acoustic Screening', desc: 'A solid-boarded hardwood gate provides genuine visual privacy and meaningful noise reduction from road traffic. Relevant for Essex properties on A-roads or in areas with consistent passing traffic.' },
      { title: 'Low Environmental Impact', desc: 'FSC-certified hardwood from responsibly managed forests is a renewable material with a lower embodied carbon than steel or aluminium. All timber species used by our Essex network are available with certification on request.' },
    ],
  ...
  'metal-gates': {
    ...
    candidates: [
      ...
      "Your site is in coastal Essex where the salt environment makes a fully galvanised specification essential",
    ],
    process: [
  ...
  'automated-systems': {
    intro: [
      ...
      "Safety compliance is not optional. All gate automation installed in the UK must meet the requirements of BS EN 12453, which sets out performance criteria for safety edges, photocell coverage, and the force limits that a closing gate is permitted to apply. An installer who does not test and document compliance is not completing the job properly. Every installer in our Essex network commissions safety systems to the required standard and provides a declaration of conformity before handover.",
    ],
    benefits: [
  ...
  'gate-repair': {
    ...
    benefits: [
      { title: 'Fast Attendance Across Essex', desc: 'Engineers in our repair network cover the whole county and aim to attend urgent callouts within 24 to 48 hours. Gates stuck open or presenting a security or safety risk are prioritised for same-day attendance where possible.' },
      { title: 'All Major Brands Serviced', desc: 'Our engineers carry diagnostic equipment and common spare parts for FAAC, BFT, CAME, Nice, Beninca, and other brands regularly installed in Essex. The majority of faults are resolved on the first visit without a return trip for parts.' },
