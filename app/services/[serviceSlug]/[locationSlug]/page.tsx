            ...
            <div className="lg:col-span-2">
              ...
              <section className="mb-12">
                ...
                <div className="prose prose-gray max-w-none text-gray-600 space-y-4">
                  <p>
                    {service.title} are one of the most commonly requested gate types among {cityName} homeowners. Our vetted installers in the area have fitted dozens of similar projects and understand the specific challenges that {cityName} properties present, from tight access to sloped driveways, period property restrictions, and local planning requirements. They will assess your property during a free site survey and recommend the best approach for your specific situation.
                  </p>
                  <p>
                    {cityName} homeowners also benefit from working with installers who know the local planning rules. While most driveway gates fall under permitted development, some Essex districts have additional guidelines around gate height, materials in conservation areas, and proximity to public highways. Our {cityName} installers handle these considerations routinely and will flag any issues during the survey.
                  </p>
                </div>
              </section>
