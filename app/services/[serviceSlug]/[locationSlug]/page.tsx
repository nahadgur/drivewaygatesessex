...
const serviceLocationContent: Record<string, {
  ...
  'wooden-gates': {
    ...
    whyPoints: (city) => [
      `Installers we refer in ${city} work with joinery firms who specialise in hardwood gates and understand the material behaviour in Essex conditions`,
  ...
  'automated-systems': {
    ...
    whyPoints: (city) => [
      ...
      'Motor brands including FAAC, BFT, CAME, Nice, and Beninca are available, with long-term parts support across Essex',
  ...
  'gate-repair': {
    intro: (city) => [
      `Gate repair engineers covering ${city} attend faults ranging from complete motor failure through to gradual degradation that makes a system unreliable or unsafe. The most common faults in the Essex residential market are motor and gearbox wear, control board failure, photocell misalignment causing false stops, hinge wear leading to sagging and binding, and on sliding gates, track contamination or drive rack deterioration. The majority of these are resolved in a single visit by an engineer who carries diagnostic equipment and common spare parts for the brands most widely installed in the area: FAAC, BFT, CAME, Nice, and Beninca.`,
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mt-6">
              <div>
                ...
                <div className="flex items-center gap-4 text-sm text-gray-400">
                  ...
                  <span>Highly rated by Essex homeowners</span>
                </div>
              </div>
              <div>
