            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                },
                {
                  ...
                  desc: 'Most Essex installers in our network can offer a free site survey slot within 7 days, including evenings and Saturdays for working homeowners.',
                },
                {
                ...
                <Link key={service.id} href={`/services/${service.slug}/`} className="group bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100">
                  ...
                  <div className="p-5">
                    ...
                    <span className="text-brand-600 font-medium text-sm flex items-center">
                      Find Essex installers <ArrowRight className="w-4 h-4 ml-1 group-hover:translate-x-1 transition-transform" />
                    </span>
                  </div>
                </Link>
              ))}
        ...
        <section className="section-padding bg-white">
          <div className="container-width">
            ...
            <div className="mt-8 bg-brand-900 rounded-2xl p-6 md:p-10 text-white text-center">
              ...
              <p className="text-brand-200 text-sm mb-6 max-w-xl mx-auto">0% interest finance is available through most Essex installers in our network. Spread the cost over 6 to 36 months with nothing to pay upfront. Subject to status and approval.</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                },
                {
                  ...
                  desc: 'We identify up to three vetted installers from our Essex network who cover your area and have specific experience with your gate type. They reach out to arrange a free site survey.',
                },
                {
                  step: '3',
        ...
        <section className="section-padding bg-white">
          <div className="container-width">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
              <div>
                <h2 className="text-3xl md:text-4xl font-display font-bold text-gray-900 mb-6">
                  Driveway Gates Built for Essex Properties
                </h2>
                <div className="space-y-5 text-gray-600 leading-relaxed">
                  <p>
